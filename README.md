...
1. 打开浏览器，访问[NDPR官网](https://ndpreforged.com/)
2. 点击上方或左上角的[服主管理](https://ndpreforged.com/fzadmin.php)
3. 登录/注册账号(温馨提示:滑块验证拖慢一点)
4. 点击左侧的[Token管理](https://ndpreforged.com/fzadmin.php?page=tokens)
5. 在上方"创建新Token"处填写uuid，然后生成Token
6. (可选)点击左侧[上传权限](https://ndpreforged.com/fzadmin.php?page=upload),点击你的Token旁的申请上传权限,等待审核
